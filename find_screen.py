...
def compareColorHistogram(image, histSize, fname):
    ...
    # H, S, V 을 차례로 접근하면서 히스토그램을 각 색깔에 맞게 그립니다.
    for i in range(3):
...
def compareColorHistogram2d(image, histSize, fname):
    '''
    H, S, V 3가지를 2개씩 묶어서 나올 수 있는 경우의 수를 모두 2d로 표현하는 함수
    '''
    # (H, S), (S, V), (V, H) 3가지 경우의 수를 표현할 수 있도록 subplot을 구성합니다.
    fig, axes = plt.subplots(1, 3, figsize=(15, 7))
    channels_mapping = {0: 'H', 1: 'S', 2: 'V'}
